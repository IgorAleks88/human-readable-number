...
module.exports = function toReadable(number) {
  ...
  var textNumber = '';
  var hundredNumber = Math.trunc(number / 100);
  ...
  if (hundredNumber > 0) {
    ...
    switch (hundredNumber) {
      ...
      case 2:
        textNumber = 'two hundred ';
        break;

      case 3:
        textNumber = 'three hundred ';
        break;

      case 4:
        textNumber = 'four hundred ';
        break;

      case 5:
        textNumber = 'five hundred ';
        break;

      case 6:
        textNumber = 'six hundred ';
        break;

      case 7:
        textNumber = 'seven hundred ';
        break;

      case 8:
        textNumber = 'eight hundred ';
        break;

      case 9:
        textNumber = 'nine hundred ';
        break;
  ...
  if (number > 19) {
    var tenNumber = Math.trunc(number / 10);
